...
public class TypeCheckTest {
  ...
  public void test1() throws FileNotFoundException {
    String filename =  "./src/test/resources/Test/"+Thread.currentThread().getStackTrace()[1].getMethodName()+".java";
  ...
  public void BinaryTree() throws FileNotFoundException {
    String filename =  "./src/test/resources/"+Thread.currentThread().getStackTrace()[1].getMethodName()+".java";
    Typecheck typecheck = new Typecheck(new FileInputStream(new File(filename)));
    assertTrue(typecheck.check());
  }
