...
public class TestType {
  ...
  private final String testResourcePrefix = "./src/test/resources/TypecheckingTestResource/";
  ...
  public void test1() throws FileNotFoundException {
    String filename = testResourcePrefix + Thread.currentThread().getStackTrace()[1].getMethodName() + ".java";
    Typecheck typecheck = new Typecheck(getParser(new FileInputStream(new File(filename))));
