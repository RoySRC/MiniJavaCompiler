...
/**
 * This symbol table visitor deals with inheritance. It goes through every class that inherits from another class,
 ...
 * function identifiers are not declared in both classes. This symbol table visitor only visits the
